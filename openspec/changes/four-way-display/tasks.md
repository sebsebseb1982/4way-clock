...
- [ ] 1.1 Créer les fichiers vides `src/mpu.h`, `src/mpu.cpp`, `src/touch_mgr.h`, `src/touch_mgr.cpp`, `src/ui_clock.h`, `src/ui_clock.cpp`, `src/ui_countdown.h`, `src/ui_countdown.cpp`, `src/ui_stub.h`, `src/ui_stub.cpp`
